...
export default class RefreshFooter extends Component {
  ...
  static defaultProps = {
    footerRefreshingText: 'loading', //  "努力加载中",
    footerLoadMoreText: 'pull up to load more data', // "上拉加载更多",
    footerFailureText: 'reload', // "点击重新加载",
    footerNoMoreDataText: 'no more data', // "已全部加载完毕"
  };
